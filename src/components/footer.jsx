    ...
    return (
        <footer className="bg-[#1F3A93] text-gray-300 py-10 px-6 mt-10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                {/* Enlaces rápidos */}
                <div>
                    <h3 className="text-lg font-semibold text-[#F5F5F5] mb-3">Enlaces</h3>
                    <ul className="space-y-2 text-sm">
                        <li><a href="/productos" className="hover:text-[#F5F5F5] transition">Productos</a></li>
                        <li><a href="/nosotros" className="hover:text-[#F5F5F5] transition">Nosotros</a></li>
                        <li><a href="/contacto" className="hover:text-[#F5F5F5] transition">Contacto</a></li>
                        <li><a href="/faq" className="hover:text-[#F5F5F5] transition">Preguntas frecuentes</a></li>
                    </ul>
                </div>

                {/* Contacto */}
                <div>
                    <h3 className="text-lg font-semibold text-[#F5F5F5] mb-3">Contáctanos</h3>
                ...
                {/* Redes sociales */}
                <div>
                    <h3 className="text-lg font-semibold text-[#F5F5F5] mb-3">Síguenos</h3>
