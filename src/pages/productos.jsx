        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative">
          <div className="text-center">
            ...
            <p className="text-xl text-[#dbeafe] max-w-3xl mx-auto leading-relaxed">
              Encuentra los mejores repuestos y accesorios con los mejores precios del mercado
            </p>
          </div>
        </div>
      </div>
                ...
                {product.discount_percentage > 0 && (
                  <div className="absolute top-4 left-4 z-10">
                    <div className="bg-gradient-to-r from-[#ef4444] to-[#dc2626] text-[#ffff] px-3 py-1 rounded-lg text-sm font-bold shadow-lg">
                      {Math.round(((product.retail_price - product.retail_price_sale) / product.retail_price) * 100)}% OFF
                    </div>
                  </div>
                )}
                        ...
                        <>
                          <div className="flex items-center space-x-3">
                            <span className="text-2xl font-bold text-[#dc2626]">
                              ${new Intl.NumberFormat('es-CL').format(product.retail_price_sale)}
                            </span>
                          ...
                          <span className="line-through text-[#94a3b8] text-lg">
                            ${new Intl.NumberFormat('es-CL').format(product.retail_price)}
                          </span>
                        </>
                      ) : (
