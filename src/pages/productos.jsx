        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative">
          <div className="text-center">
            ...
            <p className="text-xl text-[#dbeafe] max-w-3xl mx-auto leading-relaxed">
              Encuentra los mejores repuestos y accesorios con los mejores
              precios del mercado
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <div className="bg-white rounded-3xl shadow-xl p-12 max-w-md mx-auto border border-[#e2e8f0]">
              ...
              <h3 className="text-2xl font-bold text-[#334155] mb-3">
                No hay productos disponibles
              </h3>
              <p className="text-[#64748b] leading-relaxed">
                Intenta ajustar tus filtros de búsqueda para encontrar lo que
                necesitas
              </p>
            </div>
          </div>
