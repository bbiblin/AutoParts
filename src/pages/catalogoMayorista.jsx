...
import SearchBar from '../components/searchBar'; // Agregado import faltante
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <form onSubmit={handleSubmit} className="p-8">
            <div className="flex flex-col lg:flex-row items-start lg:items-end gap-8">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-[#dc2626] text-white px-10 py-4 rounded-2xl font-bold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none min-w-[200px] justify-center"
              >
                {loading ? (
                  <>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-bold text-[#1e3a8a] flex items-center">
              <div className="w-8 h-8 bg-[#1e3a8a] rounded-full flex items-center justify-center mr-3">
            ...
            {allProducts.length > 0 && (
              <div className="bg-[#dc2626] text-white px-6 py-3 rounded-3xl font-bold shadow-lg">
              ...
              >
                ...
                {product.discount_percentage > 0 && (
                  <div className="absolute top-4 left-4 z-10">
                    <div className="bg-gradient-to-r from-[#ef4444] to-[#dc2626] text-white px-3 py-1 rounded-lg text-sm font-bold shadow-lg">
                  ...
                  <div className="space-y-3">
                    ...
                    {isLoggedIn ? (
                      product.stock > 0 ? (
                        <AddToCartButton
                          product={product}
                          className="w-full bg-[#1e3a8a] hover:bg-[#1d4ed8] text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                        />
                      ) : (
